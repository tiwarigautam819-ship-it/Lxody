    ...
    <div className="min-h-screen bg-[#F4F6F9] flex items-center justify-center py-10 px-4">
      <div className="bg-white rounded-2xl shadow-xl border border-gray-100 max-w-md w-full p-6 sm:p-8 space-y-6">
        ...
        <div className="text-center space-y-1.5">
          ...
          <p className="text-xs text-gray-500">Log in to your {website?.name || 'AG Tech SMM'} account</p>
        </div>
        ...
        <form onSubmit={handleLogin} className="space-y-4">
          <div>
            ...
            <div className="relative">
              ...
              <input
                type="email"
                placeholder="user@agtechsmm.com"
                value={email}
          ...
          <div>
            <div className="flex items-center justify-between mb-1">
              ...
              <button
                ...
                className="text-xs font-bold text-[#1e60d5] hover:underline"
              >
                Forgot Password?
              </button>
            </div>
